...
public class MySqlAccountModel implements AccountModel{
    private static final String INSERT_ACCOUNT = "INSERT INTO account (fullName, userName, email, password, status ) VALUES (?, ?, ?, ?, ?);";
    private static final String UPDATE_ACCOUNT = "UPDATE account SET fullName = ?, userName = ?, email = ?, password = ?, status = ? WHERE id = ?;";
    ...
    private static final String FIND_BY_ALL = "SELECT * FROM account;";
